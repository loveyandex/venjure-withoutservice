...
import com.venjure.service.AdministratorQueryService;
import com.venjure.service.AdministratorService;
...
/**
 * REST controller for managing {@link com.venjure.domain.Administrator}.
 */
@RestController
@RequestMapping("/api")
public class AdministratorResource {
    ...
    public ResponseEntity<List<AdministratorDTO>> getAllAdministrators(AdministratorCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Administrators by criteria: {}", criteria);
        Page<AdministratorDTO> page = administratorQueryService.findByCriteria(criteria, pageable);
