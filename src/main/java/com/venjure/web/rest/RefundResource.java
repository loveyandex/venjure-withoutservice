...
import com.venjure.service.RefundQueryService;
import com.venjure.service.RefundService;
...
/**
 * REST controller for managing {@link com.venjure.domain.Refund}.
 */
@RestController
@RequestMapping("/api")
public class RefundResource {
     ...
     */
    @GetMapping("/refunds")
    public ResponseEntity<List<RefundDTO>> getAllRefunds(RefundCriteria criteria, Pageable pageable) {
