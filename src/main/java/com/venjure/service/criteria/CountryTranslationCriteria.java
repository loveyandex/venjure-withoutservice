...
/**
 * Criteria class for the {@link com.venjure.domain.CountryTranslation} entity. This class is used
 * in {@link com.venjure.web.rest.CountryTranslationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /country-translations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CountryTranslationCriteria implements Serializable, Criteria {
    ...
    public CountryTranslationCriteria() {}

    public CountryTranslationCriteria(CountryTranslationCriteria other) {
    ...
    @Override
    public CountryTranslationCriteria copy() {
        return new CountryTranslationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CountryTranslationCriteria that = (CountryTranslationCriteria) o;
        return (
    ...
    public String toString() {
        return "CountryTranslationCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
