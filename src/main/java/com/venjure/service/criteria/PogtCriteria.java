...
/**
 * Criteria class for the {@link com.venjure.domain.Pogt} entity. This class is used
 * in {@link com.venjure.web.rest.PogtResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /pogts?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PogtCriteria implements Serializable, Criteria {
    ...
    public PogtCriteria(PogtCriteria other) {
    ...
    @Override
    public PogtCriteria copy() {
        return new PogtCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PogtCriteria that = (PogtCriteria) o;
        return (
