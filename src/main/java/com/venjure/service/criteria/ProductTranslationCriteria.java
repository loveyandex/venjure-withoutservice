...
/**
 * Criteria class for the {@link com.venjure.domain.ProductTranslation} entity. This class is used
 * in {@link com.venjure.web.rest.ProductTranslationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-translations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ProductTranslationCriteria implements Serializable, Criteria {
    ...
    public ProductTranslationCriteria() {}

    public ProductTranslationCriteria(ProductTranslationCriteria other) {
    ...
    @Override
    public ProductTranslationCriteria copy() {
        return new ProductTranslationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductTranslationCriteria that = (ProductTranslationCriteria) o;
        return (
    ...
    public String toString() {
        return "ProductTranslationCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
