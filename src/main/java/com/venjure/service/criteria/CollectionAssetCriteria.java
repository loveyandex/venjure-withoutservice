...
/**
 * Criteria class for the {@link com.venjure.domain.CollectionAsset} entity. This class is used
 * in {@link com.venjure.web.rest.CollectionAssetResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /collection-assets?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CollectionAssetCriteria implements Serializable, Criteria {
    ...
    public CollectionAssetCriteria() {}

    public CollectionAssetCriteria(CollectionAssetCriteria other) {
    ...
    @Override
    public CollectionAssetCriteria copy() {
        return new CollectionAssetCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CollectionAssetCriteria that = (CollectionAssetCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdat, updatedat, position, assetId, collectionId);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "CollectionAssetCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
