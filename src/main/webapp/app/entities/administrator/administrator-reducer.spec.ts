...
describe('Entities reducer tests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ADMINISTRATOR),
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ADMINISTRATOR),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_ADMINISTRATOR actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ADMINISTRATOR),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ADMINISTRATOR),
          payload: resolvedObject,
        },
      ];
