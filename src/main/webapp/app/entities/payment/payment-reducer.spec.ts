...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PAYMENT),
          REQUEST(ACTION_TYPES.UPDATE_PAYMENT),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PAYMENT),
          REQUEST(ACTION_TYPES.DELETE_PAYMENT),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PAYMENT),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PAYMENT actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PAYMENT),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PAYMENT),
          payload: resolvedObject,
        },
      ];
