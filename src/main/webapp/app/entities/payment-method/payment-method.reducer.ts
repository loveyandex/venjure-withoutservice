...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_PAYMENTMETHOD: 'paymentMethod/PARTIAL_UPDATE_PAYMENTMETHOD',
...
export default (state: PaymentMethodState = initialState, action): PaymentMethodState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PAYMENTMETHOD):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PAYMENTMETHOD):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PAYMENTMETHOD):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IPaymentMethod> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_PAYMENTMETHOD,
