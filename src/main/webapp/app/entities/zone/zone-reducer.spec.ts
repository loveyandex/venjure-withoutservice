...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_ZONE),
          REQUEST(ACTION_TYPES.UPDATE_ZONE),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ZONE),
          REQUEST(ACTION_TYPES.DELETE_ZONE),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ZONE),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_ZONE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ZONE),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ZONE),
          payload: resolvedObject,
        },
      ];
