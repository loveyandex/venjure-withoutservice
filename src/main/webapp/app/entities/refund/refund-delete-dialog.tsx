...
export interface IRefundDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const RefundDeleteDialog = (props: IRefundDeleteDialogProps) => {
  useEffect(() => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.refundEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="venjureApp.refund.delete.question">
        <Translate contentKey="venjureApp.refund.delete.question" interpolate={{ id: refundEntity.id }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(RefundDeleteDialog);
